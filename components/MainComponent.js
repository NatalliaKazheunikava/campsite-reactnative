...
class Main extends Component {
    ...
    componentDidMount() {
        ...
        NetInfo.fetch().then(connectionInfo => {
            (Platform.OS === 'ois') ? Alert.alert('Initial Network Connectivity Type: ', connectionInfo.type) : ToastAndroid.show('Initial Network Connectivity Type: ' + connectionInfo.type, ToastAndroid.LONG)
        });
